 ...
 module.exports = {
    ...
    adminAuth: {
        ...
        users: [
            {
            username: "nodered",
            password: "$2a$08$B6uYs4pJxtnSNX1x.TF.vO6WSn9Ft1NWX8ujnNHvrmDyg3QCLQ3BO",
            permissions: "*"
            }
        ]
    },
    ...
    editorTheme: {
        ...
        //},
        logout: {
            redirect: "http://www.echteler.org" // As of 0.17
        },
        //palette: {
